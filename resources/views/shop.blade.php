                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0">
                                <ul class="list list-inline mb-0 brand-list">
                                    @foreach ($brands as $brand)
                                        <li class="list-item">
                                            <span class="menu-link py-1 d-flex justify-content-between align-items-center">
                                                <label class="mb-0">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="price-range__info d-flex align-items-center mt-2">
                                <div class="me-auto">
                                    ...
                                    <span class="price-range__min">Rp1000</span>
                                </div>
                                <div>
                                    <span class="text-secondary">Max Price: </span>
                                    <span class="price-range__max">Rp500000</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                            ...
                                            Women's <br /><strong>HIJAB</strong></h2>
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Tampil cantik dan
                                            percaya diri mulai dari hijabmu. Pilih dari beragam warna, motif, dan bahan yang
                                            bikin gaya kamu makin keren—baik untuk keseharian, hangout, atau acara spesial.
                                            </h6>
                                    </div>
                                </div>
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            ...
                            <option values="-1" {{ $order == -1 ? 'selected' : '' }}>Default</option>
